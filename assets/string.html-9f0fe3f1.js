import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as n,e}from"./app-bede4f5a.js";const l={},o=e(`<h1 id="字符串操作" tabindex="-1"><a class="header-anchor" href="#字符串操作" aria-hidden="true">#</a> 字符串操作</h1><p>本章介绍 Bash 字符串操作的语法。</p><h2 id="字符串的长度" tabindex="-1"><a class="header-anchor" href="#字符串的长度" aria-hidden="true">#</a> 字符串的长度</h2><p>获取字符串长度的语法如下。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token variable">\${<span class="token operator">#</span>varname}</span>
...
$ <span class="token builtin class-name">echo</span> <span class="token variable">\${foo<span class="token operator">,,</span>}</span>
hello
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,85),i=[o];function p(c,d){return s(),n("div",null,i)}const v=a(l,[["render",p],["__file","string.html.vue"]]);export{v as default};
