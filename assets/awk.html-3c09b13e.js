...
SYS
SYNC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，第一个字段输出时都变成了大写。</p><p>其他常用函数如下。</p><blockquote><ul><li><code>tolower()</code>：字符转为小写。</li><li><code>length()</code>：返回字符串长度。</li><li><code>substr()</code>：返回子字符串。</li><li><code>sin()</code>：正弦。</li><li><code>cos()</code>：余弦。</li><li><code>sqrt()</code>：平方根。</li><li><code>rand()</code>：随机数。</li></ul></blockquote>`,36),m=n("code",null,"awk",-1),b={href:"https://www.gnu.org/software/gawk/manual/html_node/Built_002din.html#Built_002din",target:"_blank",rel:"noopener noreferrer"},k=i(`<h2 id="条件" tabindex="-1"><a class="header-anchor" href="#条件" aria-hidden="true">#</a> 条件</h2><p><code>awk</code>允许指定输出条件，只输出符合条件的行。</p><p>输出条件要写在动作的前面。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">awk</span> <span class="token string">&#39;条件 动作&#39;</span> 文件名
...
sys
<span class="token function">sync</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接" aria-hidden="true">#</a> 参考链接</h2>`,18),h={href:"https://gregable.com/2010/09/why-you-should-know-just-little-awk.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://likegeeks.com/awk-command/",target:"_blank",rel:"noopener noreferrer"};function f(x,w){const e=l("ExternalLinkIcon");return c(),o("div",null,[r,n("p",null,[n("a",p,[u,a(e)]),s("是处理文本文件的一个应用程序，几乎所有 Linux 系统都自带这个程序。")]),v,n("p",null,[m,s("内置函数的完整列表，可以查看"),n("a",b,[s("手册"),a(e)]),s("。")]),k,n("ul",null,[n("li",null,[n("a",h,[s("An Awk tutorial by Example"),a(e)]),s(", Greg Grothaus")]),n("li",null,[n("a",g,[s("30 Examples for Awk Command in Text Processing"),a(e)]),s(", Mokhtar Ebrahim")])])])}const y=d(t,[["render",f],["__file","awk.html.vue"]]);export{y as default};
